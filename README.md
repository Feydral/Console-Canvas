...
```rust
let font = Font::load_from_file("assets/default.ccfont");
let font_bold = Font::load_from_file("assets/default_bold.ccfont");
...
src/
  ...
  canvas/
    ...
    font.rs        # Font: .ccfont file loader and glyph parser
...
assets/
  default.ccfont       # Regular bitmap font
  default_bold.ccfont  # Bold bitmap font
```
